...
const EmailRoute = () => {
  ...
  const [word_res, set_word_res] = useState("");
    ...
    <div className="w-full min-h-dvh flex justify-center items-center">
      <div className="mx-4 w-full border border-gray-300 rounded-lg p-6">
        ...
        <div className="flex w-full gap-4 mt-4">
          <SelectComponent set_value={set_tone} value={tone} label="Tone" data={promptTypes} />
          <SelectComponent value={length} set_value={set_length} label="Length" data={lengthTypes} />
        </div>
        <Button
        ...
        <EmailEdit
          ...
          set_word_res={set_word_res}
          set_to_res={set_to_res}
        />
        <div className="flex mt-4 justify-end gap-4">
          <Button className="bg-blue-400 py-6 px-4 rounded-lg cursor-pointer"  onClick={handleGenerate}>
            Regenerate
          </Button>
          <Button
